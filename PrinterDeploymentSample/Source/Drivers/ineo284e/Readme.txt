==========================================================================================
Generic 55BW-5e Series PCL/PS/FAX Printer Driver
...
PS  Version 5.1.2.0
FAX Version 5.4.0.0
Printer Installer Version 8.2.3.0

Copyright (C) 2003 KONICA MINOLTA, INC.
Copyright (c) 2010 Monotype Imaging Inc. All right reserved.
...
(1) If the Software is furnished on CD-ROM(s) or other tangible object that is used 
...
2. Introduction
//////////////////////////////////////////////////////////////////////////////////////////
This printer driver is a software that controls Generic 55BW-5e Series.
This is required to print with Generic 55BW-5e Series from your PC.
...
Other :
The following versions of  Microsoft .NET Framework must be installed in order 
...
Please read the following notes before use.
 ...
 4. When the driver installed in Windows Server 2008 is shared and installing 
    ...
    ==>In the case, please install the printer driver in the way described below.
      4-1. Please prepare the driver to add Windows Server 2008 and 
           PC in which the OS with the same number of bits is installed, and assign
...
==========================================================================================
 ...
 2. Insert the Printer Driver CD-ROM in the CD/DVD drive of your computer.

 3. Click [Printer Install].

 4. Read the contents of the displayed [Installer license agreement] screen.
...
Try the following manual installation steps if you cannot install from CD install program.

 1. Insert the Printer Driver CD-ROM in the CD/DVD drive of your computer.
 ...
 8. Locate the directory on the CD/DVD where the printer driver files are located 
...
This completes the printer driver installation.
 ...
 14. Remove the CD-ROM from the CD/DVD drive.
...
- You must have administrative rights on the computer to uninstall the printer driver.
 ...
 2. Click [MFP-Printer Utility] from the displayed menu.
...
- You must have administrative rights on the computer to uninstall the printer driver.
 ...
 4. The [Installer license agreement] screen will apperar.  Click the [Agree] button 
    to proceed.

 5. Select [Delete] and click next.

 6. Select the printer driver to be deleted from [Uninstall Printer Driver], and then 
    click [Uninstall].
    To complete the uninstall printer driver procedure, follow the directions provided 
    by the Wizard.

 7. When you are prompted to confirm the computer restart process, click [OK] and then 
    restart the computer.
...
//////////////////////////////////////////////////////////////////////////////////////////
  ...
  [Driver]Folder
    |-[Drivers]
       |-[FAX]
          |- [DE]                FAX Driver for German
          |- [EN]                FAX Driver for English
          |- [ES]                FAX Driver for Spanish
          |- [FR]                FAX Driver for French
          |- [IT]                FAX Driver for Italian
          |- [JA]                FAX Driver for Japanese
          |- [KO]                FAX Driver for Korean
          |- [ZH-CN]             FAX Driver for Simplified Chinese
          |- [ZH-TW]             FAX Driver for Traditional Chinese
      |-[PCL]
          |- [DE]                PCL Driver for German
          |- [EN]                PCL Driver for English
          |- [ES]                PCL Driver for Spanish
          |- [FR]                PCL Driver for French
          |- [IT]                PCL Driver for Italian
          |- [JA]                PCL Driver for Japanese
          |- [KO]                PCL Driver for Korean
          |- [ZH-CN]             PCL Driver for Simplified Chinese
          |- [ZH-TW]             PCL Driver for Traditional Chinese
      |-[PS]
          |- [DE]                PS Driver for German
          |- [EN]                PS Driver for English
          |- [ES]                PS Driver for Spanish
          |- [FR]                PS Driver for French
          |- [IT]                PS Driver for Italian
          |- [JA]                PS Driver for Japanese
          |- [KO]                PS Driver for Korean
          |- [ZH-CN]             PS Driver for Simplified Chinese
          |- [ZH-TW]             PS Driver for Traditional Chinese
    |-[Lang]Folder               Various Setting for each language / Help files
    |-[Bmp]Folder                Bitmap file used in installer
    |-[PPD-PageMaker]Folder
        |- [DE]                  PageMaker Driver for Germany
        |- [EN]                  PageMaker Driver for English
        |- [ES]                  PageMaker Driver for Spanish
        |- [FR]                  PageMaker Driver for French
        |- [IT]                  PageMaker Driver for Italy
        |- [JA]                  PageMaker Driver for Japanese
        |- [KO]                  PageMaker Driver for Korean
        |- [ZH-CN]               PageMaker Driver for Simplified Chinese
        |- [ZH-TW]               PageMaker Driver for Traditional Chinese
    |-[Readme]Folder
        |-[EN]
            |- [Readme.txt]      Readme file for English (This file)
        |-[JA]
            |- [Readme.txt]      Readme file for Japanese
    |-[setupsub]Folder           Subdirectory for this installer
    |-[Setup64.exe]              Printer Driver Installer
    |-[Setup.exe]                Printer Driver Installer
...
==========================================================================================
 ...
 1. Paper Size Setting  
  1-1. When not printing as paper size setting
 ...
 2. Paper Tray Setting
  ...
  2-2. When Paper Tray setting doesn't work as specified.
 ...
 3. Original Orientation Setting
  3-1. Original Orientation setting doesn't work as specified.
 ...
 4. Collate Functions
  4-1. Collate doesn't work as specified.
 ...
 5. Copies Setting
  5-1. Copies Setting doesn't work as specified.
 ...
 6. [Front Cover] / [Back Cover]
  6-1. Paper for [Front Cover] / [Back Cover]
 ...
 7. [User Authentication] / [Account Track]
  7-1. [User Authentication] / [Account Track] for use
  ...
  7-2. When the Limitation for printing  is exceeded at the [Account Track]
  ...
  7-3. [Device Option] in [Account Track]
  ...
  7-4. When verifying the registered user or account information, the verification will 
 ...
 8. [Booklet] and [Center Staple and Fold]
  8-1. Blank of Paper Center Part
 ...
 9. Two-way Communication
  9-1. Acquire Device Information
  ...
  9-2. About Two-way communication of Printer Driver and MFP
 ...
 11. OS Restrictions
  11-1. Wartermark in PCL driver for x64 Edition
  ...
  11-2. File name of Phone Book
        Fax driver could not read the Phone Book file with long file or folder name 
        because of the OS's restriction.

  11-3. Printing test pages
        [Yes] will be specified in the [Color Support] item in the printed test page.

  11-4. [General] tab in the Printer Property
        Although this machine is Black and White machine, [Color: Yes] is specified.

  11-5. PS Driver for Windows 7
  ...
  11-6. Using a WSD Port Connection in Windows 7 and Windows Server 2008 R2
  ...
  11-7. About Watermark printing in Windows 8.1
  ...
  11-14. About [Print Host Image] or [Print Device Image] printing in Windows 8.1
         In some instances, [Print Host Image] or [Print Device Image] is not printed when the print is executed 
         from Microsoft Word 2010 or Microsoft Excel 2010.
         - Printer Property -> [Settings]Tab - [EMF Spool] -> ON
         - Printer Property -> [Advaced]Tab - [Enable advanced printing features] -> ON

  11-15. Restriction of Cover Sheet in Windows 8.1 x86
 ...
 12. Others
  ...
  12-2. When sending plural printing jobs to Network Port
  ...
  12-3. Copies Setting in Application
  ...
  12-5. Document Name displayed on the panel
  ...
  12-6. Orientation and FAX Cover Sheet
...
==========================================================================================
 ...
 3. Printing Custom Size Documents
  3-1. When printing the document which length and width is the same (i.e. "square"
  ...
  3-2. When [Paper Size] is set to [Custom Size] and a print job is sent, the [Paper Size]
       set on the MFP may be different than the what is set in the Printer Driver,
       but the printed output will be normal.

 4. Overlay Function
  4-1. About Combination with [Binding Margin]
...
==========================================================================================
8-4. Cautions and restrictions with specific applications
==========================================================================================
 ...
 3. Adobe PageMaker, Illustrator
  ...
  3-2. When the Illustrator file with paper size A0/A1/B1 is printed with Illustrator CS, 
       a part of the image is lost.
       With Illustrator CS2 or more, this problem doesn't occur.

 4. Internet Explorer, Note Pad
  4-1. Check the selected printer when printing continuously by the Internet Explorer
       or Note Pad.
 ...
 5. Excel
  5-1. Check the print settings before printing when you print from Excel after 
  ...
  5-2. When you want to print multiple Excel sheets simultaneously, printing may not be 
 ...
 6. PowerPoint
  6-1. Please do not enable the following setting when you print from PowerPoint.
       It might cause to hang PowerPoint.
       - [Settings]tab - [Popup Authentication Dialog when printing]

  6-2. The background of PowerPoint data is painted with the specified color.
